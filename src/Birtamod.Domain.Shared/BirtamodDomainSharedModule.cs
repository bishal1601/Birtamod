...
public class BirtamodDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BirtamodGlobalFeatureConfigurator.Configure();
        BirtamodModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BirtamodDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BirtamodResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Birtamod");

            options.DefaultResourceType = typeof(BirtamodResource);
        ...
        {
            options.MapCodeNamespace("Birtamod", typeof(BirtamodResource));
        });
    }
}
