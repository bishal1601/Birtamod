...
{
    [DbContext(typeof(BirtamodDbContext))]
    [Migration("20260508173146_AddedPopulationManagement")]
    partial class AddedPopulationManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Birtamod.Population.Citizen", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("EducationQualificationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WardId", "Gender");

                    b.ToTable("AppCitizens", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.EducationQualification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEducationQualifications", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.Ethnicity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppEthnicities", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.FamilyType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFamilyTypes", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.Household", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FamilyHeadName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.ToTable("AppHouseholds", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Birtamod.Population.Religion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppReligions", (string)null);
                });

            modelBuilder.Entity("Birtamod.Population.Ward", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Birtamod.Population.Citizen", b =>
                {
                    b.HasOne("Birtamod.Population.EducationQualification", "EducationQualification")
                        .WithMany()
                        .HasForeignKey("EducationQualificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.Ethnicity", "Ethnicity")
                        .WithMany()
                        .HasForeignKey("EthnicityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.FamilyType", "FamilyType")
                        .WithMany()
                        .HasForeignKey("FamilyTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.Household", "Household")
                        .WithMany()
                        .HasForeignKey("HouseholdId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.Language", "Language")
                        .WithMany()
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.Religion", "Religion")
                        .WithMany()
                        .HasForeignKey("ReligionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Birtamod.Population.Ward", "Ward")
                        .WithMany()
